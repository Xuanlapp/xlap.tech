                ...
                <form wire:submit.prevent="save" class="relative rounded-lg bg-white shadow-sm">
                    <div class="flex items-center justify-between rounded-t border-b border-gray-200 p-4 md:p-5">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Nhap keyword va link anh nguon.</p>
                        </div>
                    ...
                    <div class="space-y-5 p-4 md:p-5">
                        <div>
                            ...
                            <x-input
                                ...
                                type="text"
                                class="block w-full"
                                placeholder="Vui long co chu ornament, vi du: christmas ornament"
                                autofocus
                            />
                        ...
                        <div>
                            <label for="ornament-etsy-image-link" class="mb-2 block text-sm font-medium text-gray-900">Link anh</label>
                            <div class="relative">
                                <x-input
                            ...
                            @else
                                <p class="mt-2 text-sm text-gray-500">Ho tro JPG, PNG, WebP, Google Drive va Dropbox.</p>
                            @endif
