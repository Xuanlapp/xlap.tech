            ...
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
                <div class="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        @endif
                        <button type="button" wire:click="openOrderReportImportModal" class="rounded-lg bg-orange-600 px-3 py-2 text-xs font-bold text-white hover:bg-orange-700">Import Order Report</button>
                ...
                <div class="flex flex-col gap-3 border-b border-slate-200 px-5 py-4 sm:flex-row">
                    ...
                    <select wire:model.live="perPage" class="rounded-lg border border-slate-300 px-3 py-2 text-sm"><option value="5">5 / trang</option><option value="10">10 / trang</option><option value="20">20 / trang</option><option value="50">50 / trang</option><option value="100">100 / trang</option></select>
                </div>
                @if ($items->isEmpty())
                ...
                @else
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[760px] text-left text-sm">
                            <thead class="bg-slate-50 text-xs uppercase tracking-wide text-slate-500"><tr><th class="px-5 py-3">SKU</th><th class="px-5 py-3">Product</th><th class="px-5 py-3">Images</th><th class="px-5 py-3">Link Images</th><th class="px-5 py-3">Source</th></tr></thead>
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 p-4">
                <div class="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl">
                    ...
                    <form wire:submit="updateOrderItem" class="mt-5 space-y-4">
                        <div><label class="mb-1 block text-xs font-bold text-slate-600">Product</label><select wire:model="editingOrderItemProductId" class="w-full rounded-lg border border-slate-300 px-3 py-2.5"><option value="">Chon Product</option>@foreach ($products as $product)<option value="{{ $product->id }}">{{ $product->display_name }}</option>@endforeach</select>@error('editingOrderItemProductId')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror</div>
