<div>
    <div class="px-6 py-4">
        <label for="list-radio-millitary" class="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-500">Job Number</label>
        <input wire:model="job" class="border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-36 p-2.5" type="text" placeholder="Job number">
        ...
        <div class='flex justify-end mt-5'>
            <x-atomics.button-green wire:click="submit">Send</x-atomics.button-green>
        </div>
    </div>
</div>
