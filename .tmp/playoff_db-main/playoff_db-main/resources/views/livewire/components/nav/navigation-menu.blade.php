        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="text-center mr-4">
                    ...
                    >
                        <span class="text-white font-medium rounded-lg text-sm px-5 py-2.5 cursor-pointer">
                ...
                @if($list)
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        @foreach ($links[$list] as $category => $routes)
                            @role($routes['permission'])
                            <x-nav-link href="{{ route($category,$routes['router']) }}"
                                        :active="request()->routeIs($category)">
                                <img class="h-4 mr-1" src="{{ $routes['img'] }}"
                                     alt="">
                                <span class="text-black"> {{ __($routes['name']) }}</span>
                            </x-nav-link>
                            @endrole
                        @endforeach
                    </div>
                        ...
                        <ul class="pl-4">
                            @foreach ($routes as $routeKey => $route)
                                <li class="my-2">
                                    ...
                                    <x-nav-link href="{{ route($routeKey,$route['router']) }}"
                                                :active="request()->routeIs($routeKey)">
