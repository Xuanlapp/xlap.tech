<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-5">
    <div class='text-center text-4xl text-green-500 mb-5'>🏀 NBA Export Execution</div>
    ...
    @if( $partialShowingData != [])
        ...
        @php
            ...
            $nbaId = array_key_exists("NbaId", $row)?$row['NbaId']:"";
        @endphp
        <div class="my-3 flex shadow-sm p-5 rounded-md hover:shadow-md space-x-3 w-full {{$color}}">
            ...
            <div class="flex-none">
                <img src="https://cdn.nba.com/headshots/nba/latest/1040x760/{{ $nbaId }}.png" alt="" class="object-cover h-32">
            </div>
            <div class="flex-none">
                <div class="text-2xl font-bold">{{$row['Player']}}</div>
                <div class=""><span class="text-gray-500">Player ID:</span> {{$row['PlayerID']}}</div>
                <div class=""><span class="text-gray-500">NBA ID:</span> {{$nbaId}}</div>
