<div>
    <div class="bg-slate-600 text-center h-12 py-5 flex items-center justify-center text-xl text-white">Find WNBA Player Id</div>
    <div wire:loading class="p-5 flex-col items-center justify-center">
        <p class="text-2xl text-center">Looking WNBA Player Id, wait until it completed.
        </p>
