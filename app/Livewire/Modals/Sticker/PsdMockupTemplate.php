...
class PsdMockupTemplate extends Component
{
    ...
    {
        if ($component !== 'modals.sticker.psd-mockup-template') {
            return;
        }
    ...
    {
        app(PsdMockupTemplateService::class)->activateStickerTemplate(auth()->user(), $templateId);
    ...
    {
        return view('livewire.modals.sticker.psd-mockup-template', [
            'templates' => app(PsdMockupTemplateService::class)->stickerTemplatesForUser(auth()->user()),
        ]);
    }
}
