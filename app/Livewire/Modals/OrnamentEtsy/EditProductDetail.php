...
class EditProductDetail extends Component
{
    ...
    {
        if ($component !== 'modals.ornament-etsy.edit-product-detail') {
            return;
        }
    ...
    public function open(int $assetId): void
    {
        ...
        $asset = app(OrnamentEtsyService::class)->assetForUser(auth()->user(), $assetId);
    ...
    {
        return view('livewire.modals.ornament-etsy.edit-product-detail');
    }
}
