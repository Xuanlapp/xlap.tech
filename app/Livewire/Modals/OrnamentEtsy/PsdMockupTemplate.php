...
class PsdMockupTemplate extends Component
{
    ...
    {
        if ($component !== 'modals.ornament-etsy.psd-mockup-template') {
            return;
        }
    ...
    public function save(): void
    {
        ...
        try {
            ...
            $this->dispatch('ornament-etsy-psd-mockup-template-updated');
    ...
    {
        return view('livewire.modals.ornament-etsy.psd-mockup-template', [
