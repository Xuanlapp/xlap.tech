...
{
    public const ORNAMENT_ETSY_CUSTOM_MOCKUP = 'ornament_etsy_custom_mockup';
    ...
    public function ornamentTemplatesForUser(User $user): Collection
    {
        return $this->templates->forUserProductAndFunction(
            ...
            self::ORNAMENT_ETSY_CUSTOM_MOCKUP,
        );
    }
    ...
    public function uploadOrnamentTemplate(User $user, UploadedFile $file, ?string $name = null): PsdMockupTemplate
    {
        ...
        $path = $file->storeAs("psd-mockups/{$user->id}/ornament-etsy", $filename, 'public');
    ...
    {
        return $this->products->findActiveBySlug('ornament-etsy');
    }
